export const SITE = {
  ...
  address: {
    line1: "399- EE, Scheme no. 94, Near Mayur Hospital",
    line2: "Near Bengali Square Indore",
  },
  ...
  mapsEmbed: "https://www.google.com/maps?q=399-EE,+Scheme+no.+94,+Near+Mayur+Hospital,+Near+Bengali+Square+Indore&output=embed",
  mapsLink: "https://www.google.com/maps/search/?api=1&query=399-EE,+Scheme+no.+94,+Near+Mayur+Hospital,+Near+Bengali+Square+Indore",
};
...
export const AMENITIES = [
  { title: "The Mandapam Banquet", desc: "A grand 1800 sq feet hall with cinematic ceilings and traditional jaali screens.", icon: "sparkles" },
