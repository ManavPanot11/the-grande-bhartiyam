  ...
  return (
    ...
    >
      ...
      <span className="relative flex items-center p-3 rounded-full bg-[#25D366] text-white shadow-luxe hover:bg-[#1ebe5d] transition-colors">
        ...
        <span className="max-w-0 overflow-hidden opacity-0 group-hover:max-w-[200px] group-hover:opacity-100 group-hover:ml-3 group-hover:pr-2 transition-all duration-500 ease-in-out whitespace-nowrap text-sm font-medium tracking-wide">
          Chat on WhatsApp
        </span>
      </span>
    </a>
